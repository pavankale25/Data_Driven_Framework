...
public class TestBase {
	...
	public void reportTeardown() throws InterruptedException {
		...
		extent.setSystemInfo("URL","https://www.orangehrm.com/");
	...
	public void tearDown(ITestResult result) throws IOException,MessagingException {
	    ...
	    //fail test cases screenshort attch in report
public void extentReportSpark() throws IOException {
		...
		spark.config().setDocumentTitle("OrangeHRM Automation Testing Report");
		spark.config().setReportName("OrangeHRM Automation Test Suite");
